...
### Replication Controllers ( workload resources )
...
--> lab: generiamo un deployment di due pod di nginx che usano una emptydir e poi scaliamo a ZERO repliche. Cosa succederà?
